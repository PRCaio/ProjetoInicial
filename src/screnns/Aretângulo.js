...
export default props => {
  ...
  return (
   <SafeAreaView style={styles.container} >
    ...
    <Text style={styles.text}> A = {base} . {altura} </Text>
    <Text style={styles.text}> A área do retângulo é igual a {result}. </Text>
    ...
    <Image source={Aretangulo} style={styles.fundo} /> 

    <Text style={styles.text}>Para calcular a área do retângulo ou quadrado aplicamos a fórmula:</Text>
    <Text style={styles.text}> A= b x h </Text>
    <Text style={styles.text}> Onde b é a base do retângulo </Text>
    <Text style={styles.text}> e h é a altura do retângulo. </Text>
    </View>
