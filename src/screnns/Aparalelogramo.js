...
import Aparalelogramo from'../fundo/Aparalelogramo.jpg'
...
export default props => {
  ...
  return (
   <SafeAreaView style={styles.container} >
    ...
    <Text style={styles.text}> A = {base} x {altura} </Text>
    <Text style={styles.text}> A área do paralelogramo é igual a {result}. </Text>
    ...
    <Image source={Aparalelogramo} style={styles.fundo} /> 

    <Text style={styles.text}>Para calcular a área do paralelogramo aplicamos a fórmula:</Text>
