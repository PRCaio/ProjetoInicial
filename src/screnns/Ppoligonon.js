...
import Ppoligonon from'../fundo/Ppoligonon.jpg'

export default props => {

  const [result, setResult] = useState('L . n')
  const [altura, setAltura] = useState('n')
  const [base, setBase] = useState('L')
  ...
  function calc() {
    ...
    else{setResult(eval(`${altura}*${base}`))}
  ...
  return (
   <SafeAreaView style={styles.container} >
    ...
    <View style={styles.viewInput}><TextInput style={{textAlign: 'center', backgroundColor:'#f0f8ff', fontSize:22, height: 40}} keyboardType='numeric' placeholder="n lados"
    ...
    <Text style={styles.text}> P = {base} x {altura} </Text>
    <Text style={styles.text}> O perímetro do polígono é igual a {result}. </Text>
    ...
    <Image source={Ppoligonon} style={styles.fundo} /> 

    <Text style={styles.text}>Para calcular o perímetro do polígono regular com n lados aplicamos a fórmula:</Text>
    <Text style={styles.text}> P = L . n </Text>
    <Text style={styles.text}> Onde n é o número de lados do polígono e L é o valor do lado. </Text>
